...
<div
    ...
    <div class="hidden md:block md:w-5/12 relative">
        ...
        <div class="absolute bottom-0 left-0 p-8 w-full">
            <h2 class="text-3xl font-bold text-white mb-2 shadow-black drop-shadow-md">Pendaftaran Warga</h2>
            <p class="text-white/90 drop-shadow-sm font-medium">Bergabunglah untuk melaporkan dan memantau aspirasi
    ...
    <div class="w-full md:w-7/12 p-8 sm:p-10 flex flex-col overflow-y-auto no-scrollbar bg-base-100"
        ...
        <div class="flex items-center justify-center gap-4 mb-6">
            ...
            <div class="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center p-1 text-primary">
                <x-icon name="o-megaphone" class="w-6 h-6" />
            </div>
        </div>

        <div class="text-center mb-6">
            <h1 class="text-2xl font-bold text-base-content mb-1">Daftar Akun Baru</h1>
        ...
        <form wire:submit="register" class="space-y-4">
            ...
            <p class="text-xs text-base-content/50 text-center pb-2">Password minimal 8 karakter, wajib kombinasi huruf
                dan angka.</p>
        ...
        <p class="mt-6 text-center text-sm text-base-content/60">
            Sudah punya akun?
            <a href="{{ route('login') }}" class="text-primary hover:underline font-bold" wire:navigate>Masuk</a>
        </p>
    </div>
